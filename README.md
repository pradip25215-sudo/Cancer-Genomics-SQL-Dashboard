...
|-------|---------------|
| SQL Database Design | 2-table SQLite with indexes |
| Advanced SQL | JOINs, CTEs, aggregates, subqueries |
| ETL Pipeline | Raw data → cleaned → SQL database |
| Statistical Analysis | Chi-square, log-rank tests |
| Survival Analysis | Kaplan-Meier curves |
| Multivariate Statistics | Cox Proportional Hazards model |
| Data Visualization | Matplotlib + Seaborn + Plotly |
| Interactive Dashboard | Streamlit multi-page app |
| Domain Knowledge | Cancer genomics, clinical outcomes |
...
![mutations](mutation_frequencies.png)

### Gene x Cancer Heatmap
![heatmap](gene_cancer_heatmap.png)

### Kaplan-Meier Survival Curves
![survival](survival_analysis.png)
...
```bash
pip install pandas numpy matplotlib seaborn plotly scipy lifelines sqlalchemy
```
